        ...
        for (int i = 0; i < limitLines.size(); i++) {
            ...
            if (label != null && !label.equals("")) {
                ...
                if (position == LimitLine.LimitLabelPosition.RIGHT_TOP) {
                    ...
                    paint.setColor(getContrastColor(l.getTextColor())) ;
                    paint.setStyle(Paint.Style.FILL);
                    //mLimitLinePaint.setAlpha(60);


                    RectF rc = new RectF ( (int)(mViewPortHandler.contentLeft() + xOffset - Utils.convertDpToPixel(4f) ) ,
                            (int)(pts[1] - yOffset + labelLineHeight - mLimitLinePaint.getTextSize() - Utils.convertDpToPixel(7f)) ,
                            (int)(mViewPortHandler.contentLeft() + xOffset + mLimitLinePaint.measureText(label) + Utils.convertDpToPixel(4f)) ,
                            (int)(pts[1] - yOffset + labelLineHeight )) ;

                    c.drawRoundRect(  rc , 11 , 11 , paint );
                    ...
                    c.drawText(label,
                            ...
                            pts[1] - yOffset + labelLineHeight - Utils.convertDpToPixel(5f) , mLimitLinePaint);
