...
public class Transformer {
    ...
    float[] other_ptsBuffer = new float[2];
    ...
    public MPPointD getownValuesByTouchPoint( boolean first , float x, float y) {
        ...
        if ( first )
        {
            ...
            other_ptsBuffer[0] = oldx;
            other_ptsBuffer[1] = oldy;
        }
        else
        {
            other_ptsBuffer[0] = oldx;
            other_ptsBuffer[1] = oldy - (( oldy - y )*2) ;
        }
        ...
        result.x = other_ptsBuffer[0];
        result.y = other_ptsBuffer[1];
